 ...
 */
export function GitPanel({ gitStatus, onStageFile, onUnstageFile, onStageAll, onUnstageAll, onCommit, onDiscardChanges, onClose, onGetLog }) {
  ...
  return (
    <div className="h-full flex flex-col bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl">
      {/* 头部 - 显示分支名 */}
